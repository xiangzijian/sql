...
GROUP BY numbers.city_name, numbers.month_string
HAVING COUNT(DISTINCT CASE WHEN o.order_month = numbers.month_string THEN o.order_no END) > 0  -- 只显示有数据的城市月份
ORDER BY numbers.city_name, numbers.month_string